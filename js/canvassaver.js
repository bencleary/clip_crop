function CanvasSaver(url) {
	...
	this.saveCanvas = function  (cnvs, fname) {
		var btn = document.getElementById('button'), scope = this;
		btn.addEventListener('click', function(){alert(fname);scope.savePNG(cnvs, fname);}, false);  
		};
